...
<%--<script src="${pageContext.request.contextPath}/plugins/dashboard/assets/pages/scripts/ui-buttons.min.js" type="text/javascript"></script>--%>
...
<%--&lt;%&ndash;<script src="${pageContext.request.contextPath}/plugins/dashboard/assets/global/plugins/jstree/dist/jstree.min.js" type="text/javascript"></script>&ndash;%&gt;--%>
<%--&lt;%&ndash;<script src="${pageContext.request.contextPath}/plugins/dashboard/assets/pages/scripts/ui-tree.min.js" type="text/javascript"></script>&ndash;%&gt;--%>
...
<script src="${pageContext.request.contextPath}/plugins/dashboard/assets/pages/scripts/table-datatables-fixedheader.min.js" type="text/javascript"></script>
<script src="${pageContext.request.contextPath}/plugins/dashboard/assets/pages/scripts/table-datatables-responsive.min.js" type="text/javascript"></script>
