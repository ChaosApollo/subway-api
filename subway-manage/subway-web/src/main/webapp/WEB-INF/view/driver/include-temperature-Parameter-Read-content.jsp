            ...
            <div class="portlet light form-fit ">
                <div class="portlet-body form">
                    <div class="form-body"style="padding-top: 10px;padding-bottom: 10px">
                        ...
                        <div class="form-group"style="padding-left: 10px">
                            <label for="temperature_read" class="col-sm-2 control-label "
                                   style="text-align: center; ">读取温度</label>
                            <div class="col-sm-5">
                                <input type="text" path="temperature_read" class="form-control"
                                       id="temperature_read" placeholder="" value="50"/>
                            </div>
                        </div>
