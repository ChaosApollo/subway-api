            ...
            <div class="portlet light form-fit ">
                <div class="portlet-body form">
                    <div class="form-body"style="padding-top: 10px;padding-bottom: 10px">
                        <fieldset>
                            <legend style="border: 0px;margin-bottom: 0px">禁播表读取</legend>
                            <div class="form-group"style="padding-left: 10px">
                                <label for="program_id" class="col-sm-2 control-label "
                                       style="text-align: center; ">节目号</label>
                                <div class="col-sm-5">
                                    <input type="text" path="program_id" class="form-control"
                                           id="program_id" placeholder="" value="0"/>
                                </div>
                            </div>
                            <div class="form-group"style="padding-left: 30px">
                                <div class="clearfix" style="margin-top: 10px">
                                    <button type="button" class="btn green">读取</button>
                                    <button type="button" class="btn green">导出监播表</button>
                                    <button type="button" class="btn green">清除禁播表</button>
                                </div>
                            </div>
                        </fieldset>
                    </div>
