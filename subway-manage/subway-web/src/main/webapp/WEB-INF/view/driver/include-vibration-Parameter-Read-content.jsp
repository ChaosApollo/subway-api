            ...
            <div class="portlet light form-fit ">
                <div class="portlet-body form">
                    <div class="form-body"style="padding-top: 10px;padding-bottom: 10px">
                        ...
                        <div class="form-group"style="padding-left: 10px">
                            <label for="vibration_read" class="col-sm-2 control-label "
                                   style="text-align: center; ">读取震动</label>
                            <div class="col-sm-5">
                                <input type="text" path="vibration_read" class="form-control"
                                       id="vibration_read" placeholder="" value=""/>
                            </div>
                        </div>
