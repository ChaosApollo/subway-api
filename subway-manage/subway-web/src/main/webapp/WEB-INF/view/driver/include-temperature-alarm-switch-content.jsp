            ...
            <div class="portlet light form-fit ">
                <div class="portlet-body form">
                    <div class="form-body"style="padding-top: 10px;padding-bottom: 10px">
                        ...
                        <div class="form-group"style="padding-left: 10px">
                            <label for="temperature_alarm_switch" class="col-sm-2 control-label "
                                   style="text-align: center; ">温度报警允许开关</label>
                            <div class="input-group" style="padding-left: 20px">
                                <div class="icheck-inline" id="temperature_alarm_switch">
                                    <label>
                                        <input type="radio" path="temperature_alarm_switch" name="radio0" checked class="icheck"> 打开 </label>
                                    <label>
                                        <input type="radio" path="temperature_alarm_switch" name="radio0" class="icheck"> 关闭 </label>
                                </div>
                            </div>
                        </div>
