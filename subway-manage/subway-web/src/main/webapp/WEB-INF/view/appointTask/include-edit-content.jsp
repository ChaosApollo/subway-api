                    ...
                    <div class="form-body"style="padding-top: 10px;padding-bottom: 10px">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <label for="name" class="col-sm-2 control-label"><span class="required">*</span>合同编号：</label>
                                <div class="col-sm-3">
                            ...
                            <div class="form-group" style="margin-bottom: -10px;margin-left: 8px;margin-right: 8px">
                                <div>
                                    <div class="btn-group" id="btngroup2" >
                                        ...
                                        <a type="button" class="btn green" style="margin-bottom: 10px;margin-right: 8px">
                                            <span>修改节目号</span>
                                        </a>
